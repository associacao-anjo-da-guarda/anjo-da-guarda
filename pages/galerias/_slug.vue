            ...
            >
                ...
                <o-section v-if="gallery.body">
                    ...
                    >
                        ...
                        <a-text v-html="$md.render(gallery.body)" />

                    </o-wrapper>

                </o-section>

                <o-section v-if="gallery.galleryMedias">
                    ...
                    >
                        ...
                        <a-image
                            v-for="(media, index) in gallery.galleryMedias"
                            :key="index"
                            :src="media.image"
                            is-bg
                            width="100%"
...
export default {
    async asyncData ({ params, payload }) {
        if (payload) { return { gallery: payload } } else {
            return {
                gallery: await require(`~/assets/content/galleries/${params.slug}.json`)
            }
        }
    }
}
